...
float DroneCalculator::CalculateAngleBetweenDroneAndTarget(DataStructs::Position3D dronePosition, const float& droneDirection, const DataStructs::Position2D& targetPosition)
{
...
DataStructs::Position2D DroneCalculator::CalculateManeuverPosition(float minAttackDistance, float droneToTargetDistance, DataStructs::Position2D dronePosition, DataStructs::Position2D targetPosition)
{
	float x;
	float y;
...
DataStructs::Position2D DroneCalculator::CalculateFirePosition(float fallDistance, float droneToTargetDistance, DataStructs::Position2D dronePosition, DataStructs::Position2D targetPosition)
{
	float ratio = 0;
	if (droneToTargetDistance > 0.0)
	{
...
bool DroneCalculator::IsDistanceBetweenPointSameAsNeeded(const DataStructs::Position2D& position1, const DataStructs::Position2D& position2, float neededDistance)
{
